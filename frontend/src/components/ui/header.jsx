      ...
      <div className="container mx-auto pl-4">
        <nav className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <Button variant="outline" className="ml-4 p-5 rounded-3xl">
              Log In
            </Button>
            <Button className="bg-blue-500 hover:bg-blue-600 text-white rounded-3xl p-5">
              Sign Up
            </Button>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="flex flex-col space-y-4 mt-4 p-4 bg-white rounded-lg shadow-lg md:hidden">
            ...
            <Button variant="outline" className="p-5 rounded-3xl">
              Log In
            </Button>
            <Button className="bg-blue-500 hover:bg-blue-600 text-white rounded-3xl p-5">
              Sign Up
